...
// // import { getCardItems, removeFromCart, updateCartQuantity } from '@/app/actions/actions.ts/actions';
...
// //                             </div>
// //                             <button onClick={() => handleRemove(item._id)} className="px-4 py-2 bg-red-500 text-white rounded">Remove</button>
// //                         </div>
// //                     ))
// //                 )}
// //             </div>
...
// //                 <button onClick={handleProceed} className="px-6 py-2 bg-blue-500 text-white rounded">Proceed to Checkout</button>
// //             </div>
// //         </div>
// //     );
// // };
