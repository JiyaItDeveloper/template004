...
const client = createClient({
  projectId: process.env.NEXT_PUBLIC_SANITY_PROJECT_ID='bctdstw8',
  dataset: process.env.NEXT_PUBLIC_SANITY_DATASET='production',
  token: process.env.SANITY_API_TOKEN='skQCkduLaSsd6LFi2vGNdkgitFwGBucIvvGx8rTJSiY5EK0XvnRZuhgRK1m1T9of8QecegGpZZAeeBRUo56CCu7rc91Sxm2XEhkmX3F7N5UOsdoUf08MucIertxUSVYaQnxf33tshbglc7QYRtgDqehId4vU9v33ppkL7boGko6Rjmm8CXA7',
