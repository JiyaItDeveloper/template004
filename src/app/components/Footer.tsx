    ...
    <div className="bg-gray-100 py-16 text-gray-600">
      ...
      <div className="flex justify-between items-center w-[90%] mx-auto">
          ...
          <div className="flex space-x-4">
            <a href="https://github.com/Anosha804" className="w-8 h-8 rounded-full bg-[#151875] flex items-center justify-center text-white hover:bg-blue-700">
              <FaFacebookF />
            </a>
            <a href="@anoshafatima804" className="w-8 h-8 rounded-full bg-[#151875] flex items-center justify-center text-white hover:bg-blue-700">
              <FaTwitter />
            </a>
            <a href="@anoshafatima1995" className="w-8 h-8 rounded-full bg-[#151875] flex items-center justify-center text-white hover:bg-blue-700">
              <FaInstagram />
            </a>
          </div>
        </div>
