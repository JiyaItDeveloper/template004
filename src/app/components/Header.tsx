    ...
    <>
        ...
        <div className="w-full max-w-[1200px] h-full flex justify-between items-center px-10">
          ...
          <div className="hidden sm:flex items-center gap-x-8">
            <ul className="flex gap-x-8 items-center">
              ...
              <li className="relative">
                ...
                {isPagesDropdownOpen && (
                  <ul className="absolute top-full mt-2 z-50 bg-white shadow-md rounded-md text-black text-sm">
          ...
          >
            {isMobileMenuOpen ? (
              ...
              <HiMiniBars3 className="w-6 h-6 text-black" />
            )}
          </button>
        </div>
      </div>
      ...
      {isMobileMenuOpen && (
        <div className="sm:hidden flex flex-col items-center px-4 py-2 border-t">
          ...
          {isPagesDropdownOpen && (
            <ul className="w-full text-center z-50 bg-white shadow-md rounded-md text-black text-sm">
              <li className="px-4 py-2 hover:bg-gray-100">
                <Link href="/cart">Cart</Link>
              </li>
              <li className="px-4 py-2 hover:bg-gray-100">
